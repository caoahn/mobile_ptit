...
export default function CreateRecipeScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background-light">
      ...
      {/* Navigation Header */}
      <View className="flex-row items-center justify-between border-b border-[#dde4e3]/30 bg-background-light/80 px-4 py-4 backdrop-blur-md">
        <TouchableOpacity
          onPress={() => router.back()}
        ...
        <Text className="flex-1 text-center font-display text-lg font-extrabold leading-tight tracking-tight text-[#121716]">
          Create New Recipe
        </Text>
      ...
      <ScrollView className="flex-1 pb-32">
        ...
        <View className="flex-col gap-3 p-6">
          <View className="flex-row items-end justify-between">
            <View>
              <Text className="text-2xl font-extrabold tracking-tight text-[#121716]">
                Basic Info
              </Text>
            ...
            <View className="flex-row gap-1">
              ...
              <View className="h-1.5 w-8 rounded-full bg-[#dde4e3]" />
              <View className="h-1.5 w-8 rounded-full bg-[#dde4e3]" />
            </View>
          </View>
        </View>
        ...
        <View className="px-6 pb-6">
          <TouchableOpacity className="group relative flex aspect-[16/10] w-full flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-[#dde4e3] bg-white transition-all hover:border-primary/50 ]">
            ...
            <View className="flex-col items-center gap-2 text-center">
              ...
              <View className="px-8 items-center">
                ...
                <Text className="mt-1 text-xs text-[#67837f]">
        ...
        <View className="flex-col gap-6 px-6">
          ...
          <View className="flex-col gap-2">
            <Text className="ml-1 text-sm font-bold text-[#121716]">
              Recipe Name
            </Text>
            <TextInput
              className="w-full rounded-xl bg-white p-4 text-lg font-bold shadow-sm transition-shadow focus:ring-2 focus:ring-primary/20 ]"
          ...
          <View className="flex-col gap-2">
            <View className="flex-row items-center justify-between ml-1">
              <Text className="text-sm font-bold text-[#121716]">
                Short Description
              </Text>
            ...
            <TextInput
              multiline
              className="min-h-[140px] w-full rounded-xl bg-white p-4 text-base leading-relaxed shadow-sm transition-shadow focus:ring-2 focus:ring-primary/20 ]"
          ...
          <View className="flex-col gap-3">
            ...
            <View className="flex-row flex-wrap gap-2">
              {tags.map((tag, index) => (
                <View
                  key={index}
                  className={`flex-row items-center gap-1 rounded-full px-4 py-2 ${index === 0 ? "bg-primary shadow-md shadow-primary/20" : "bg-white border border-[#dde4e3] ]"}`}
                >
                  <Text
                    className={`text-sm font-bold ${index === 0 ? "text-white" : "text-[#121716]"}`}
                  >
                    {tag}
                  </Text>
                  <TouchableOpacity
              ...
              <TouchableOpacity className="flex-row items-center gap-1 rounded-full border-2 border-dashed border-[#dde4e3] px-3 py-1.5 hover:border-primary transition-all">
      ...
      <View className="absolute bottom-0 left-0 right-0 z-50 bg-background-light/80 border-t border-[#dde4e3]/30 px-6 py-5 backdrop-blur-xl">
